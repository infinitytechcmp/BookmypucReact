    ...
    <PublicLayout>
      <div className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-4xl">
          <GradientHeading level={1} className="mb-8 text-4xl font-bold">Terms & Conditions</GradientHeading>
          <div className="prose prose-slate max-w-none dark:prose-invert">
            <p className="text-muted-foreground">Last updated: March 31, 2026</p>

            <GradientHeading level={2} className="mt-8 text-2xl font-semibold">1. Acceptance of Terms</GradientHeading>
            <p>
            ...
            <GradientHeading level={2} className="mt-8 text-2xl font-semibold">2. Service Description</GradientHeading>
            <p>
            ...
            <GradientHeading level={2} className="mt-8 text-2xl font-semibold">3. User Responsibilities</GradientHeading>
            <p>You agree to:</p>
            ...
            <GradientHeading level={2} className="mt-8 text-2xl font-semibold">4. Booking and Cancellation</GradientHeading>
            <p>
            ...
            <GradientHeading level={2} className="mt-8 text-2xl font-semibold">5. Payment Terms</GradientHeading>
            <p>
            ...
            <GradientHeading level={2} className="mt-8 text-2xl font-semibold">6. Limitation of Liability</GradientHeading>
            <p>
            ...
            <GradientHeading level={2} className="mt-8 text-2xl font-semibold">7. Intellectual Property</GradientHeading>
            <p>
            ...
            <GradientHeading level={2} className="mt-8 text-2xl font-semibold">8. Termination</GradientHeading>
            <p>
            ...
            <GradientHeading level={2} className="mt-8 text-2xl font-semibold">9. Changes to Terms</GradientHeading>
            <p>
              We may modify these terms at any time. Continued use of our services after changes
              constitutes acceptance of the modified terms.
            </p>

            <GradientHeading level={2} className="mt-8 text-2xl font-semibold">10. Governing Law</GradientHeading>
            <p>
              These terms are governed by the laws of India. Any disputes shall be subject to the
              exclusive jurisdiction of courts in Mumbai, India.
            </p>

            <GradientHeading level={2} className="mt-8 text-2xl font-semibold">11. Contact Information</GradientHeading>
            <p>
